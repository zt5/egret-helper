...
### 修改
- egret命令行添加到配置
- 添加`serverCmd`配置 Egret开启Http服务器使用的命令
- 添加`buildCmd`配置 Egret编译项目使用的命令
- 添加`buildEngineCmd`配置 Egret编译引擎使用的命令

[2.0.41]: https://github.com/zt5/egret-helper/releases/tag/v2.0.41
-----------------------------------------------------------------------------------------------------------
## [2.0.4] - 2020-12-02
